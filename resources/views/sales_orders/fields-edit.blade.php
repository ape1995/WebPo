    ...
    <div class="row">
        ...
        <div class="col-sm-12 mb-1">
            <div class="row">
                ...
                <div class="col-8">
                    <select name="order_type_show" id="order_type_show" class="form-control select2js" required disabled>
                        <option value="R" {{ $salesOrder->order_type == 'R' ? 'selected' : '' }}>REGULAR</option>
                        <option value="G" {{ $salesOrder->order_type == 'G' ? 'selected' : '' }}>DIRECT SELLING</option>
