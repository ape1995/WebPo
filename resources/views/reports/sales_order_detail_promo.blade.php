...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">{{ trans('report.title_2') }} Promo</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('reportSalesOrder.detailPromoView') }}" method="post">
                                @csrf
                                        ...
                                        <tbody>
                                            @foreach ($salesOrders as $salesOrder)
                                                @foreach ($salesOrder->detail as $salesOrderDetail)
                                                    @foreach ($salesOrderDetail->packet->detail as $detail)
                                                        <tr>
                                                            <td>AD</td>
                                                            <td>F01</td>
                                                            ...
                                                            <td>{{ $detail->qty * $salesOrderDetail->qty }}</td>
